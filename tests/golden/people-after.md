...
<picture><source media="(prefers-color-scheme: dark)" srcset="assets/contributors-dark.svg"><img alt="Contributors to DFWB Research" src="assets/contributors-light.svg"></picture>

With thanks to [example-contributor](https://github.com/example-contributor).
